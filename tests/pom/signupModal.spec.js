...
test.describe("Signup modal window", () => {
  ...
  test("signup all fields filled out", async () => {
  ...
  test.describe("Signup negative testcases", () => {
    test("Signup all fields empty", async () => {
      const signUpName = "";
    ...
    test("Signup Name field empty", async () => {
      const signUpName = "";
      const signUpLastName = "Geller";
      const email = "aqa-ross@test.com";
      const password = "12345678Qwerty";
    ...
    test("Signup Lastname field empty", async () => {
      const signUpName = "Ross";
      const signUpLastName = "";
      const email = "aqa-ross@test.com";
      const password = "12345678Qwerty";
    ...
    test("Signup email field empty", async () => {
      const signUpName = "Ross";
      const signUpLastName = "Geller";
      const email = "";
      const password = "12345678Qwerty";
    ...
    test("Signup password field empty", async () => {
      const signUpName = "Ross";
      const signUpLastName = "Geller";
      const email = "aqa-ross@test.com";
      const password = "";
    ...
    test("Signup repeatPassword field empty", async () => {
      const signUpName = "Ross";
      const signUpLastName = "Geller";
      const email = "aqa-ross@test.com";
      const password = "12345678Qwerty";
